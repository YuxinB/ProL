...
def get_prompt(n, bernoulli_p):
    ...
    txt1 = "Consider the following sequence of outcomes generated by two Bernoulli distributions, where all even outcomes are generated by a Bernoulli distribution with parameter 'p' and odd outcomes are generated from a Bernoulli distribution with parameter '1-p' 2 different Bernoulli random trials\n\n"
...
def gen_txt(model_id, bernoulli_p):
    ...
    for n in tqdm.tqdm(range(2, 100, 6)):
        ...
        for seed in range(seeds):
            ...
            errs = []
            for idx, ni in enumerate(numbers[-1]):
                if ni == "1" or ni == "0":
                    if ni == "1":
                        err = 1 - bernoulli_p
                    else:
