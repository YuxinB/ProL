...
if __name__ == "__main__":
    ...
    fnames_syn_s3 = ["./checkpoints/scenario3_v2/erm_mlp_errs.pkl",
                     "./checkpoints/scenario3_v2/prospective_mlp_errs.pkl"] # TODO
    ...
    fnames_mnist_s2 = ["./checkpoints/mnist_s2_v2/erm_mlp_errs.pkl",
                       ...
                       "./checkpoints/mnist_s2/mlp_bgd_errs.pkl"]      # TODO
    ...
    create_metrics(fnames_cifar_s2, fout_cifar_s2, model_names_s2)
    create_metrics(fnames_cifar_s3, fout_cifar_s3, model_names_s3)
