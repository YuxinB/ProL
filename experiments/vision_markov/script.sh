...
# # prosp. transformer
# python run_vision_markov.py -m device='cuda:2' method="conv_proformer" multihop=True epochs=150 batchsize=16 t=0,200,500,700,1000,1200,1500,1700,2000,2500,3000,4000 hydra.launcher.n_jobs=1

# # transformer
# python run_vision_markov.py -m device='cuda:3' method="conv_proformer" multihop=False epochs=150 batchsize=16 t=0,200,500,700,1000,1200,1500,1700,2000,2500,3000,4000 hydra.launcher.n_jobs=1
