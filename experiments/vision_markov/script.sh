...
python run_baseline_1.py -m device='cuda:1' method="cnn" epochs=200 batchsize=64 t=0,200,500,700,1000,1200,1500,1700,2000,2500,3000,4000 hydra.launcher.n_jobs=10
...
# transformer
python run_vision_markov.py -m device='cuda:0' method="proformer" multihop=False epochs=300 batchsize=32 t=0,200,500,700,1000,1200,1500,1700,2000,2500,3000,4000 hydra.launcher.n_jobs=6
