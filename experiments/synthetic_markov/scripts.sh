...
# prosp. transformer
# python run_synthetic_markov.py -m device='cuda:2' method="proformer" multihop=True epochs=300 batchsize=64 t=0,200,500,700,1000,1200,1500,1700,2000,2500 hydra.launcher.n_jobs=8
