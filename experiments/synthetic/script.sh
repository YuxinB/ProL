...
# time MLP
python run_synthetic.py -m device='cuda:1' method="timemlp" epochs=500 batchsize=64 t=0,100,200,500,700,1000,1200,1500,1700,2000,2500 hydra.launcher.n_jobs=8
